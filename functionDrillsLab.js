...
//const jsNinja = () => 'I am a JavaScript ninja!'
 //console.log('I am a Javascipt ninja!')

////////////////// PROBLEM 3 ////////////////////
/*
  Create a function called printName which takes in a person's name 
  and console logs it.
  Ex. If 'Cameron' were passed in as the argument, 
...
function greeting(name){
  name = String(name) // why convert to a string?
  console.log(`Hello, ${name}`)
}
greeting('Giles')
...
/*
    Write an arrow function called 'compareNums' that takes 
    in 2 parameters, 
...
// console.log(compareNums(32,14))

////////////////// PROBLEM 6 ////////////////////
/*
  Create a function called add that takes in two parameters 
  Inside, convert the arguments to be numbers (just in case strings 
    get sent in)
  The add function should RETURN the two parameters added together.
  Create a variable outside the function called 'sum' and set it
   equal to add invoked (called), passing in 2 arguments.
*/
...
function printAllNames(arr){
  ...
  console.log(arr[i])} 
  ///this function is dynamic and can loop any array and print that name. array should be created for it is called but outside the function
}
